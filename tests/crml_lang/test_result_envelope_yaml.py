...
def test_simulation_result_envelope_yaml_str_round_trip() -> None:
    env = CRSimulationResult.model_validate(_minimal_envelope_dict())
...
def test_simulation_result_envelope_yaml_file_round_trip(tmp_path) -> None:
    env = CRSimulationResult.model_validate(_minimal_envelope_dict())
